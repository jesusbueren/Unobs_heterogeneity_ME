module dimensions
    ...
    integer,parameter::K=5,par=15,M=2,types_a=2 !K: points of support of flow; M:types of moonzoons; type_a: types of areas
...
module primitives
    ...
    double precision::rho=5.0d0,v_nod=0.0d0
    !area of plots
