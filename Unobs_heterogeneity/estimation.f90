...
1   n_initial_all(1:plots_in_map,:)=1    
    ...
    p_g(1,:)=(/15.8d0,0.9d0,0.13d0,0.0d0/)
    p_g(2,:)=(/28.19d0,0.037d0,0.9d0,-0.1d0/)
    p_g(3,:)=(/32.d0,0.54d0,1.0d0-0.54d0,2.1d0/)
    p_g(4,:)=(/8.33d0,0.64d0,0.54d0,1.1d0/)
    p_g(5,:)=(/7.33d0,0.34d0,0.44d0,-0.1d0/)
