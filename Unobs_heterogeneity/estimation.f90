...
1   print*,'Generating beliefs'
    ...
    p_g(1,:)=(/20.6d0,0.1d0,0.2d0,0.1d0/)
    p_g(2,:)=(/24.6d0,0.2d0,0.3d0,0.2d0/)
    p_g(3,:)=(/26.1d0,0.3d0,0.1d0,0.3d0/)
    p_g(4,:)=(/20.7d0,0.36d0,0.1d0,0.4d0/) 
    p_g(5,:)=(/20.7d0,0.2d0,0.2d0,0.8d0/)
