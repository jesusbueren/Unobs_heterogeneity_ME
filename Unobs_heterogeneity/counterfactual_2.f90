subroutine counterfactual_2(params_MLE)
    ...
    double precision,dimension(2*P_max-1,2,P_max,types_a,villages,unobs_types,re_types)::CCP_true
    double precision,dimension(2*P_max-1,3,P_max,types_a,unobs_types,re_types)::V_fct
